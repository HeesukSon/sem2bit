package heesuk.sem2bit.kb.protocol.iot;
...
import heesuk.sem2bit.kb.protocol.enums.*;
...
public class IoTProtocolKBUtil extends ProtocolKBUtil implements IProtocolKBUtil {
	...
	public void addUpdateHistory(){
		...
		MessageFieldUpdate u3 = new MessageFieldUpdate(
				new MessageField("Property Length", MessageFieldType.OFFSET),
		...
		MessageFieldUpdate u5 = new MessageFieldUpdate(
				...
				RequirementChange.SIMPLIFICATION, UpdatePattern.CHANGE_VOCA,
	...
	private void addMQTTv3(){
		...
		msg.addField(new MessageField("Connect flag", MessageFieldType.CONNECT_FLAG, MessageFieldLocation.HEADER, "8"));
	...
	private void addMQTTv5(){
		...
		msg.addField(new MessageField("Keep alive", MessageFieldType.KEEP_ALIVE, MessageFieldLocation.HEADER, "16"));
		msg.addField(new MessageField("Remaining Length", MessageFieldType.MESSAGE_LENGTH, MessageFieldLocation.HEADER, "v"));
		msg.addField(new MessageField("Property Length", MessageFieldType.OFFSET, MessageFieldLocation.HEADER, "8"));
	...
	private void addAMQP(){
		...
		msg.addField(new MessageField("DOff", MessageFieldType.OFFSET, MessageFieldLocation.HEADER, "8"));
