 ...
 */
public class SubSample implements MqttCallback {
    ...
    String url = protocol + broker + ":" + port;
		...
		try {
			...
			SubSample sampleClient = new SubSample(url, clientId, cleanSession, quietMode,userName,password);
   ...
   * @param password the password for the user
	 ...
	 */
    public SubSample(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
